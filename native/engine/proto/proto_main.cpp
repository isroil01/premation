// premation-viewport-proto — the C1 viewport prototype, kept buildable so
// docs/VIEWPORT_ROUTE.md stays reproducible. NOT the engine (that is
// ../src/main.cpp). Route B (native child window) was rejected by C1 and its
// code deleted when C2 started, as the decision recorded. Usage:
//
//   premation-viewport-proto --route bench|A|C [--width 1920] [--height 1080] [--scale 1]

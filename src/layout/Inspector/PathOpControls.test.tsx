...
import { setPathOps, readPathOpConfig } from '@core/scene/pathOps';
...
describe('PathOpControls — Wiggle Paths', () => {
  it('offers Wiggles/Second and Random Seed for Wiggle Paths', () => {
    const id = newShape();
    setPathOps(id, [{ id: 'o1', type: 'roughen', amount: 8, detail: 4, wigglesPerSecond: 2, seed: 3 }]);
  ...
  it('hides both on operators that do not vary with time', () => {
    const id = newShape();
    setPathOps(id, [{ id: 'o1', type: 'twist', amount: 30, detail: 0 }]);
  ...
  it('round-trips the new fields through the scene graph', () => {
    ...
    const id = newShape();
    setPathOps(id, [{ id: 'o1', type: 'roughen', amount: 5, detail: 3, wigglesPerSecond: 4.5, seed: 12 }]);
  ...
  it('defaults a pre-temporal operator to a frozen wiggle', () => {
    ...
    const id = newShape();
    setPathOps(id, [{ id: 'o1', type: 'roughen', amount: 5, detail: 3 }] as never);
